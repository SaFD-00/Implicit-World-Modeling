...
# examples/custom/IWM-AC_EXP01_ratio{37,55,73}/stage1_{full,lora}/{MODEL_SHORT}_world-model.yaml
# 을 require_yaml 한다 (notebook Cell 8 가 ratio 별 디렉토리에 YAML 을 생성).
...
for MODEL_SHORT in "${MODELS[@]}"; do
  for DS in "${DATASETS[@]}"; do
    YAML="examples/custom/IWM-${DS}/stage1_${STAGE1_MODE}/${MODEL_SHORT}_world-model.yaml"
