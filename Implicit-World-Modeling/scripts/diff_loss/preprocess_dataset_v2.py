...
def process_sample(
    ...
    if is_action != starts_with_action:
        print(f"[WARN] line {line_no}: images={len(sample.get('images', []))}인데 "
...
def preprocess(
    ...
    print(f"[INFO] metric={metric_version} | 템플릿: {tkey} | 가중치 ADDED={w_added} MODIFIED={w_modified} UNCHANGED={w_unchanged}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--metric-version", choices=["v1", "v2"], default="v2",
