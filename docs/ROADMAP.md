...
| **AC_EXP05** | 🔄 **학습 중** | stage1 full FT **A100×2 진행 중** (2026-07-14~) · **stage2 `qwen2.5-vl-3b` LoRA(base) 완주**(2026-07-16, macro_step_accuracy 0.261→0.560) · `qwen2.5-vl-7b` stage2 는 **사용자 지시로 스킵**. **데이터 쟁점 4건 미판정** |
